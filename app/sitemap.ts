...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    '/doanh-nghiep/gop-von-co-dong',
    '/doanh-nghiep/ra-soat-phap-ly-noi-bo',
    '/doanh-nghiep/quy-che-noi-bo',
    '/doanh-nghiep/so-huu-tri-tue',
    '/doanh-nghiep/ma-dau-tu',
    '/dao-tao',
    ...
    '/tranh-tung-thu-hoi-no/tranh-chap-lao-dong',
    '/tranh-tung-thu-hoi-no/tranh-chap-co-dong',
