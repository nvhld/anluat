      ...
      <main>
        <article className="mx-auto max-w-3xl space-y-8 px-4 py-8 sm:px-6 md:py-14">
          ...
          <section className="space-y-4 leading-relaxed text-text-secondary">
            ...
            <p>
              Phiên bản website này cung cấp thông tin giới thiệu và kênh gọi điện trực tiếp. Website không có biểu mẫu tiếp nhận vụ việc, không yêu cầu tải tài liệu và không lưu nội dung vụ việc trong trình duyệt.
            </p>
          </section>
          ...
          <section className="space-y-4 leading-relaxed text-text-secondary">
            ...
            <p>
              Nhà cung cấp hạ tầng có thể xử lý nhật ký kỹ thuật cơ bản cần thiết để vận hành, bảo mật và phòng chống lạm dụng. An Luật không dùng website này để thu thập nội dung tư vấn pháp lý hoặc dữ liệu nhạy cảm.
            </p>
          </section>
